...
/**
 * Taken and modified from http://stackoverflow.com/a/21818297
 */
public class Generator {
    ...
    public Generator(int aDimension) {
        // Initialize
        this(aDimension, aDimension * 2);
    }
    // constructor
    ...
    public String toString() {
        ...
        grid[gridDimensionX - 2][gridDimensionY - 1] = ' ';
    ...
    public static void main(String[] args) throws IOException {
        Generator maze = new Generator(40);
        //maze.solve();
        System.out.print(maze);
        FileWriter writer = new FileWriter("data/grid.txt");
